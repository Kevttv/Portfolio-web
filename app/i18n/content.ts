...
const dictionary: Record<Locale, PortfolioDictionary> = {
  es: {
    ...
    projects: {
      ...
      sideLabel: 'Laboratorio en marcha',
      sideProjects: [
        {
          name: 'AI Workflow Sandbox',
          description: 'Experimentos con prompts, validaciones y automatizacion en tareas de soporte.',
          status: 'En desarrollo',
        },
        {
          name: 'Portfolio Analytics Pulse',
          description: 'Panel ligero para entender visitas, clicks y conversiones del portfolio.',
          status: 'Planeado Q3',
        },
      ],
    },
  ...
  en: {
    ...
    projects: {
      ...
      sideLabel: 'In-progress lab',
      sideProjects: [
        {
          name: 'AI Workflow Sandbox',
          description: 'Prompt experiments, validation layers, and support-task automations.',
          status: 'In progress',
        },
        {
          name: 'Portfolio Analytics Pulse',
          description: 'Lightweight panel to understand visits, clicks, and portfolio conversion events.',
